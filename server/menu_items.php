        ...
        <form class='review create-review-card' method='POST'>
          <div class='create-review review-details'>
            ...
            <div class='create-review-stars'>
              <input class='radio-star' id='star0-$itemId' disabled hidden checked type='radio' id='star0-$itemId' name='rating' value='0' autocomplete='off' />
              <label class='star-label' for='star0-$itemId' hidden></label>
...
function menuItemMaker($itemId, $name, $desc, $price, $category, $rating, $image) {
    ...
    return "<div id='menu-$itemId' data-name='$name' data-description-'$desc' data-price='$price' data-category='$category' data-img='$image' class='menu-card'>
              ...
              <button class='menu-card-button' onclick='addToCart($itemId)'>
